            ...
            <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        {/* Logo */}
                        <Link href="/" className="relative logo-pulse group">
                            <Logo className="h-12 w-auto transition-transform duration-300 group-hover:scale-105" />
                        </Link>

                        {/* Desktop Navigation */}
                        <nav className="hidden lg:flex items-center space-x-8" style={{ fontFamily: 'Lato, sans-serif' }}>
                                ...
                                >
                                    {item.hasDropdown ? (
                                        <button className={`flex items-center space-x-1 nav-underline font-medium text-[#113F64] hover:text-[#34969E] transition-colors duration-300 ${
                                            isActiveRoute(item.link) ? 'text-[#34969E]' : ''
                                        }`}>
                                            <span>{item.name}</span>
                        ...
                        <div className="hidden lg:block">
                            <button className="px-6 py-3 bg-gradient-to-r from-[#34969E] to-[#C2D92C] text-white font-bold rounded-full hover:from-[#C2D92C] hover:to-[#34969E] transition-all duration-300 transform hover:scale-105 shadow-lg" style={{ fontFamily: 'Lato, sans-serif' }}>
            ...
            <div className={`fixed inset-0 z-40 lg:hidden transition-all duration-500 ${
                ...
                <div className={`absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#113F64] via-[#34969E] to-[#C2D92C] transform transition-transform duration-500 ${
                    ...
                    <div className="pt-24 px-8 h-full overflow-y-auto">
                        <nav className="space-y-6" style={{ fontFamily: 'Lato, sans-serif' }}>
                            {navigationItems.map((item, index) => (
                            ...
                            <div className="animate-fadeInUp stagger-6 opacity-0 pt-8">
                                <button className="w-full px-6 py-4 bg-white text-[#113F64] font-bold rounded-full hover:bg-[#C2D92C] hover:text-white transition-all duration-300 transform hover:scale-105" style={{ fontFamily: 'Lato, sans-serif' }}>
