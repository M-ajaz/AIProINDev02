...
import { EnhancedFAQSection, GeometricBackground } from "@/components";
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen">
                    ...
                    <div className="space-y-8" data-aos="fade-right">
                        ...
                        <button className="group relative px-12 py-6 bg-gradient-to-r from-lime-400 to-teal-500 text-navy-800 font-bold text-xl rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
