...
const ITConsultingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        <div className="lg:w-1/2 text-white" data-aos="fade-right">
                            ...
                            <Link href="/contact-us">
                                <button className="px-8 py-4 bg-gradient-to-r from-teal-500 to-lime-400 hover:from-lime-400 hover:to-teal-500 text-navy-600 font-bold text-lg rounded-full transition-all duration-300 hover:scale-105 hover:shadow-xl group">
            ...
            {/* Comprehensive IT Consulting Services - Bento Grid */}
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-up" data-aos-delay="200">
                        {/* Large card */}
                        <div className="lg:col-span-2 lg:row-span-2 bg-gradient-to-br from-navy-600 to-teal-500 rounded-3xl p-8 text-white hover:scale-105 transition-all duration-300 group cursor-pointer">
                        ...
                        {/* Medium card */}
                        <div className="lg:col-span-2 bg-gradient-to-br from-teal-500 to-lime-400 rounded-3xl p-6 text-navy-600 hover:scale-105 transition-all duration-300 group cursor-pointer">
                        ...
                        {/* Small card */}
                        <div className="bg-gradient-to-br from-lime-400 to-teal-500 rounded-3xl p-6 text-navy-600 hover:scale-105 transition-all duration-300 group cursor-pointer">
                        ...
                        {/* Small card */}
                        <div className="bg-gradient-to-br from-navy-600 to-lime-400 rounded-3xl p-6 text-white hover:scale-105 transition-all duration-300 group cursor-pointer">
                        ...
                        {/* Medium card */}
                        <div className="lg:col-span-2 bg-gradient-to-br from-gray-900 to-navy-600 rounded-3xl p-6 text-white hover:scale-105 transition-all duration-300 group cursor-pointer">
                        ...
                        {/* Small card */}
                        <div className="bg-gradient-to-br from-teal-500 to-navy-600 rounded-3xl p-6 text-white hover:scale-105 transition-all duration-300 group cursor-pointer">
                        ...
                        {/* Small card */}
                        <div className="bg-gradient-to-br from-lime-400 to-navy-600 rounded-3xl p-6 text-white hover:scale-105 transition-all duration-300 group cursor-pointer">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                image: "https://images.unsplash.com/photo-1573166364366-3f4f8b1857ea"
                            },
                            {
            ...
            <section className="py-20 bg-gradient-to-br from-navy-600 via-teal-500 to-lime-400 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                    <div data-aos="fade-up">
                        ...
                        <Link href="/contact-us">
                            <button className="px-10 py-4 bg-white text-navy-600 font-bold text-lg rounded-full hover:bg-gray-100 transition-all duration-300 hover:scale-105 hover:shadow-xl group">
                                <span className="flex items-center gap-3">
